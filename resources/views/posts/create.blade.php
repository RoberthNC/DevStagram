...
@section('contenido')
    <div class="m-10 md:flex md:items-center">
        ...
        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{ route('posts.store') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="titulo" name="titulo" type="text" placeholder="Tu título de la publicación" class="border p-3 w-full rounded-lg @error('titulo') border-red-500 @enderror" value="{{ old('titulo') }}">
                    @error('titulo')
